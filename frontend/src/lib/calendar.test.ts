...
describe('日历日期计算', () => {
  ...
  it('日视图覆盖 08:00 到 21:00，并排除结束边界后的日程', () => {
    ...
    const lateSchedule = schedule('晚间日程', '2026-08-28T20:30:00+08:00', '2026-08-28T21:00:00+08:00')
    const afterRange = schedule('范围外日程', '2026-08-28T21:00:00+08:00', '2026-08-28T22:00:00+08:00')
  ...
  it('普通位置的半小时日程使用真实 30.5px 高度', () => {
    const item = schedule('半小时日程', '2026-08-28T11:30:00+08:00', '2026-08-28T12:00:00+08:00')
